...
if __name__ == "__main__":
    ...
    trials = [
      ...
      #   { 'filename': 'BN1105196.png', 'DARK_BG': False, 'alpha': 0.15, 'log_range':(-1,3)},
        { 'filename': 'T-BN0013990_fetalsurface_fixed_ruler_lights_filter_12_0130-dd.png', 'DARK_BG': False, 'alpha': 0.15, 'log_range':(-1,2.5)},
        { 'filename': 'T-BN0033885_fetalsurface_fixed_ruler_lights_filter_12_0109-dd.png', 'DARK_BG': False, 'alpha': 0.15, 'log_range':(-1,2.5)},
        { 'filename': 'T-BN0061827_fetalsurface_fixed_ruler_lights_filter_12_0627-AG.png', 'DARK_BG': False, 'alpha': 0.15, 'log_range':(-1,2.5)},
        { 'filename': 'T-BN0124393_fetalsurface_fixed_ruler_lights_filter_12_0628-AG.png', 'DARK_BG': False, 'alpha': 0.15, 'log_range':(-1,2.5)},
        { 'filename': 'T-BN0164923_fetalsurface_fixed_ruler_lights_filter_12_0320-AG.png', 'DARK_BG': False, 'alpha': 0.15, 'log_range':(-1,2.5)},
        { 'filename': 'T-BN0204423_fetalsurface_fixed_ruler_lights_filter_11_1118-ddy.png', 'DARK_BG': False, 'alpha': 0.15, 'log_range':(-1,2.5)},
        { 'filename': 'T-BN0224265_fetalsurface_fixed_ruler_lights_filter_12_0606-lgm.png', 'DARK_BG': False, 'alpha': 0.15, 'log_range':(-1,2.5)},
        { 'filename': 'T-BN9238868.png', 'DARK_BG': False, 'alpha': 0.15, 'log_range':(-1,2.5)},
        { 'filename': 'T-BN9730834_fetalsurface_fixed_ruler_lights_filter_12_0416.png', 'DARK_BG': False, 'alpha': 0.15, 'log_range':(-1,2.5)},
    ]
