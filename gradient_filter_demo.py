...
for n, sigma in enumerate(scales):
    ...
    f0 = frangi_from_image(img, sigma, beta=BETA, dark_bg=False,
                           dilation_radius=20, gradient_filter=False)

    f1 = frangi_from_image(img, sigma, beta=BETA, dark_bg=False,
                           dilation_radius=20, gradient_filter=True)
